...
public void adminMenuNavigation() {
    ...
    try {
        ...
        if (isMenuVisible && "Admin".equals(menuTitle)) {
            ...
            // Use admin menu items from AdminPage class
            String[][] adminItems = AdminPage.ADMIN_MENU_ITEMS;
...
public void completeLoginAndTabSelection() {
    try {
        ...
        // Verify tabs are present and clickable using the constants from CompleteLoginPage
        log.info("Verifying tabs functionality");
        for (String tab : CompleteLoginPage.ALL_TAB_NAMES) {
